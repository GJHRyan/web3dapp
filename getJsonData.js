...
$(document).ready(function(){
	 ...
	 $.getJSON('./model/data.json', function(jsonObj) {
		...
		//Get the coke2 main text data
		$('#x3dModelTitle_coke2').html('<h2>' + jsonObj.pageTextData[7].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_coke2').html('<p>' + jsonObj.pageTextData[7].x3dCreationMethod + '<p>');
 		$('#title_coke2').html('<h2>' + jsonObj.pageTextData[7].title + '<h2>');
		$('#subTitle_coke2').html('<h3>' + jsonObj.pageTextData[7].subTitle + '</h3>');
		$('#description_coke2').html('<p>' + jsonObj.pageTextData[7].description + '</p>');
